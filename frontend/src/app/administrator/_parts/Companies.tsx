...
export function Companies() {
  ...
  const { companies, fetchUsersOfCompanies } = useAdmin();
  ...
  return (
    <div className="flex-1 overflow-y-auto p-8 space-y-8 bg-muted/30 text-foreground">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* ✅ Dialog is completely separate from Sheet — no conflict */}
        <Dialog>
      ...
      {/* ✅ Sheet is OUTSIDE the map, controlled by simple boolean */}
      <Sheet open={sheetOpen} onOpenChange={(open) => { if (!open) closeSheet(); }}>
        <SheetContent className="w-105 overflow-y-auto p-6 z-999">
          <SheetHeader>
