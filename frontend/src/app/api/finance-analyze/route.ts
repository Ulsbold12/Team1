...
- "Цалин" → "цалин", "ажлын хөлс", "tsalin", "ajliinhuls", "salary", "wages" гэх мэт
- "Хоол хүнс" → "хоол", "lunch", "dinner", "food", "café", "coffee", "xool", "hool", "ресторан", "restaurant", "cafe", "гуанз", "цай", "tea", "bakery" гэх мэт
- "Тээвэр" → "bus", "taxi", "ubcab", "flight", "бензин", "benzin", "tulsh", "түлш", "тээвэр", "transport", "fuel", "petrol" гэх мэт
- "Бараа материал" → "бараа", "material", "baraa", "building material", "construction", "материал", "b1", "нийлүүлэлт", "supply", "supplies" гэх мэт
- "Тоног төхөөрөмж" → "тоног", "tonog", "t1", "т1", "equipment", "machine", "техник", "компьютер", "computer", "phone", "утас" гэх мэт
- "Орон байр/Түрээс" → "түрээс", "rent", "building", "байр", "office", "оффис" гэх мэт
- "Харилцаа холбоо" → "internet", "phone bill", "утасны", "мобикон", "mobicom", "unitel", "skytel", "gmobile", "г-мобайл" гэх мэт
- "Банкны шимтгэл" → "шимтгэл", "commission", "fee", "service charge", "bank fee" гэх мэт
- "Бусад" → дээрх ангилалд тохирохгүй зарлагууд ЗӨВХӨН ЭНД орно. Аль болох цөөн гүйлгээ "Бусад"-д оруул.
