    ...
    <Card className="rounded-2xl shadow p-0">
      <CardHeader className="px-6 pt-6 pb-2">
        <div className="flex items-start justify-between gap-2">
          ...
          {lastSaved && (
            <span className="text-xs text-slate-400 dark:text-gray-500 shrink-0 mt-1">
              Хадгалсан:{" "}
              {lastSaved.toLocaleDateString("mn-MN", {
                month: "short",
                day: "numeric",
              })}
            </span>
        ...
        <p className="text-slate-500 dark:text-gray-400 text-sm mt-1">
          Маркетинг AI-тай ярьж тантай тохирсон 30 хоногийн контент төлөвлөгөө
          гаргаарай
        </p>
      </CardHeader>
      ...
      <CardContent className="px-6 pb-6 flex flex-col gap-4">
          ...
          <div
            ...
            className={[
              ...
              dragging
                ...
                : "border-slate-200 dark:border-gray-700 hover:border-[#5048e5]/40 hover:bg-slate-50 dark:hover:bg-gray-800",
            ].join(" ")}
          >
            <ImagePlus className="size-6 text-slate-400 dark:text-gray-500" />
            <p className="text-xs text-slate-500 dark:text-gray-400">
              Зураг чирж тавих эсвэл{" "}
              <span className="text-[#5048e5] font-medium">сонгох</span>
            </p>
            <input
              ref={fileInputRef}
              type="file"
          ...
          {images.length > 0 && (
            <div className="grid grid-cols-3 gap-2 mt-1">
              {images.map((img, i) => (
                <div
                  key={i}
                  className="relative group rounded-lg overflow-hidden border border-slate-200 dark:border-gray-700 aspect-square"
                >
        ...
        >
          {loading
            ? (loadingStep ?? "Үүсгэж байна...")
            : "Контент стратеги гаргах"}
        </Button>
        ...
        {advice && (
          <div className="flex gap-3 rounded-xl bg-[#5048e5]/5 border border-[#5048e5]/15 p-4 mt-1">
            ...
            <div>
              <p className="text-sm font-semibold text-[#5048e5] mb-1">
                AI зөвлөгөө
              </p>
              <p className="text-sm text-[#5048e5]/80 leading-relaxed">
                {advice}
              </p>
            </div>
          </div>
