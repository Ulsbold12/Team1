...
const features = [
  {
    ...
    mock: (
      <div
        className="mt-5 rounded-xl p-4 bg-slate-50"
    ...
    mock: (
      <div className="mt-5 space-y-2">
        {[
          ...
          <div
            key={label}
            className="flex items-center justify-between rounded-lg px-4 py-3 bg-white"
  ...
  },
  {
    ...
    mock: (
      <div
        className="mt-5 rounded-xl p-4 bg-white"
  ...
  },
  {
    ...
    mock: (
      <div className="mt-5 space-y-2">
        ...
        <div
          className="rounded-xl px-4 py-3 text-xs leading-relaxed text-slate-500 bg-slate-50"
          style={{ border: "1px solid #E2E8F0" }}
        >
